...
public class PrincipalClienteUI extends JFrame {
	...
	public PrincipalClienteUI() {
		...
		cadastroPessoasTB
				.setToolTipText("Realizar manuten��o no cadastro de pessoas");
		...
		cadastroTarifasTB
				.setToolTipText("Realizar manuten��o no cadastro de tarifas");
		...
		cadastroTemporadasTB
				.setToolTipText("Realizar manuten��o nas temporadas");
		...
		sairTB.setToolTipText("Sair da aplica��o");
	...
	protected JMenuBar createMenuBar() {
		...
		JMenu fileMenuAnalise = new JMenu("An�lises");
		...
		// Item de menu cadastro.
		menuItem = new JMenuItem("Restri��es de tarifas");
		...
		// Item de menu cadastro
		menuItem = new JMenuItem("Canais de Distribui��o");
		...
		// Item de menu an�lise
		menuItem = new JMenuItem("Tempo de perman�ncia");
		menuItem.setMnemonic(KeyEvent.VK_T);
		menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T,
				ActionEvent.ALT_MASK));
		...
		// Item de menu an�lise
		menuItem = new JMenuItem("Ocupa�ao por segmento/classes de tarifas");
		menuItem.setMnemonic(KeyEvent.VK_O);
		menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O,
				ActionEvent.ALT_MASK));
		...
		// Item de menu an�lise
		menuItem = new JMenuItem("Ocupa��o por restri��es de tarifas");
		menuItem.setMnemonic(KeyEvent.VK_R);
		menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R,
				ActionEvent.ALT_MASK));
		...
		// Item de menu an�lise
		menuItem = new JMenuItem("Consumo por segmento exceto di�rias");
		...
		// Item de menu an�lise
		menuItem = new JMenuItem("Estadia m�dia por segmento");
		menuItem.setMnemonic(KeyEvent.VK_T);
		menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T,
				ActionEvent.ALT_MASK));
		...
		// Item de menu an�lise
		menuItem = new JMenuItem("Previs�o de demandas flutuantes");
